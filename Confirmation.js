      ...
      <Container>
        <Content contentContainerStyle={styles.content}>
          ...
          <View style={styles.buttonContainer}>
            <Button bordered danger style={styles.submitButton} onPress={() => { this.props.navigation.navigate('Third');}}>
              <Text style={styles.buttonText}>Go Back</Text>
            </Button>
            <Button bordered success style={styles.submitButton} onPress={() => { this.pay(fullName,contactNumber,contactEmail,streetAddress,city,zipCode,selectedState);}}>
