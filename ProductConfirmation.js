...
export default class App extends Component<Props>
 {
   ...
   state = { productInfo: [], productURL: null };
   static navigationOptions =
   { title: 'Confirmation', headerStyle: { backgroundColor: 'f4511e', }, headerTintColor: 'black' };
    ...
    return (
      <Container>
        <Content contentContainerStyle={styles.content}>
          ...
          <Thumbnail square large source={{uri: productPhoto}}
          style={{ height: 300, alignSelf: 'center', marginTop: 25, width: 300, }}/>
          <View style={styles.buttonContainer}>
          <Button bordered danger style={styles.submitButton} onPress={() => this.props.navigation.navigate('Second')}>
